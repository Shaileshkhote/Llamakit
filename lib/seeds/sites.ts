...
export const seedAnalyticsSites: AnalyticsSite[] = [
  {
    id: "site-uniswap",
    ownerUserId: null,
    slug: "uniswap",
  ...
  },
  {
    ...
    displayName: "Lido",
    protocolDescription:
      "A staking-focused site used to prove that LlamaKit hides unsupported modules cleanly.",
...
export const seedTenants = seedAnalyticsSites
